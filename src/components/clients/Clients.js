        ...
        <section id='clients-container'>
            ...
            <a className='client-link' href='https://sunset-city.netlify.app/'>
                <div className='client-project-container'>
                    <h5 className='client-title'>Sunset City</h5>
                    <p className='client-description'>A newly proposed RPG system currently in the development and funding stage, click on the project to see an example of the landing page before public release.</p>
